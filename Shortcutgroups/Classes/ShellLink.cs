...
namespace Shortcutgroups.Classes {
    public class ShellLink {
        public static void InstallShortcut(string exePath, string appId, string description, string workingDirectory, string iconLocation, string saveLocation, string arguments) {
